...
def iteration(model, attn_model, weight_model, train_loader, test_loader, loss_func, optim, device, class_num, hidden_dim, train=True, MMD=False, template_method="WeightNet"):
    w=class_num
...
def main():
    ...
    while True:
        ...
        loss, acc = iteration(model, attn_model, weight_model, train_loader, test_loader, loss_func, optim, device,
                class_num, args.hidden_dim, train=True, MMD=args.MMD,template_method=args.template)
        ...
        loss, acc = iteration(model, attn_model, weight_model, train_loader, test_loader, loss_func, optim, device,
                  class_num, args.hidden_dim, train=False, MMD=False,template_method=args.template)
